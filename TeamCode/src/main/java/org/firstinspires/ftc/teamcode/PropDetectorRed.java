...
public class PropDetectorRed extends OpenCvPipeline {
     ...
     */
    public PropDetectorRed(int width) {
        this.width = width;
    }
    ...
    public Mat processFrame(Mat input) {
        ...
        Scalar lowHSV = new Scalar(10, 100, 100); // lower bound HSV for red
        Scalar highHSV = new Scalar(0, 255, 255); // higher bound HSV for red
        Mat thresh = new Mat();
        ...
        if (left) location = PropLocation.MIDDLE;
        ...
        else location = PropLocation.LEFT;
