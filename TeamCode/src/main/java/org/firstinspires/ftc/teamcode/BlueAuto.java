...
public class BlueAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action move1 = drive.actionBuilder(startPose)
            ...
            Action move1b = drive.actionBuilder(new Pose2d(23, 15, 0))
                    .strafeTo(new Vector2d(15, 16))
                    .strafeTo(new Vector2d(26, 19))
                    .build();

            Action move1c = drive.actionBuilder(new Pose2d(24, 19, 0))
                    .lineToX(15)
        ...
        Action move22 = drive.actionBuilder(new Pose2d(25, 1, 0))
            ...
            Action move2b = drive.actionBuilder(new Pose2d(34, 7, 0))
                    .lineToX(20)
